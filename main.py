...
pygame.display.set_caption("Dino Game - by Prabudhd ")
...
class Dino():
    def __init__(self, sx=-1, sy=-1):
        ...
        self.imgs1, self.rect1 = load_sprite_sheet('dino_ducking1.png', 2, 1, 59, sy, -1)
...
def introduction_screen():
    ...
    logo,l_rect = load_image('logo-1.png',300,300, 1)
